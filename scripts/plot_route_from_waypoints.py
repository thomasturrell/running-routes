...
- Adds Shuttle Radar Topography Mission (SRTM) elevation to graph nodes and factors elevation gain/loss into routing
  costs.
...
def fetch_srtm_elevations(graph, nodes=None, batch_size=90):
    ...
    Args:
        ...
        batch_size (int): Number of coordinates to include per request to the SRTM endpoint.
...
def add_srtm_elevation_to_graph(graph, gain_penalty=10.0, loss_penalty=2.0):
    """
    Annotate the graph with SRTM elevation data and attach elevation-aware routing costs.
